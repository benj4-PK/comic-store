...
<body>
    ...
    <main>
        ...
        <p>Agradecemos que le haya dado una posibilidad a esta pagina en desarrollo</p>
        <br>
        <p>A continuacion tendra el enlace a la seccion de productos:</p>

        <button id="PagProducto"><a href="productos.php">Ver productos</a></button>
        <button id="PagProducto"><a href="logout.php">Cerrar Sesion</a></button>
    </main>
    <footer>
